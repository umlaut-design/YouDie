{
  BASS 0.9 Multimedia Library
  -----------------------------
  (c) 1999-2001 Ian Luck.
  Please report bugs/suggestions/etc... to bass@un4seen.com

  Delphi API Version 0.9 by Rogier Timmermans
  -------------------------------------------
  Questions, suggestions, etc. regarding the Delphi API
  can be sent to magicrt@hotmail.com

  NOTE: This unit will only work with BASS.DLL version 0.9
...
Function BASS_StreamCreateURL(URL : PChar; flags:DWORD):HSTREAM;stdcall;external 'bass.dll' name 'BASS_StreamCreateURL';
{
